...
{
    public class AdminLayoutNavbarMessageInboxViewComponent : ViewComponent
    {
        private readonly IIdentityService _identityService;
        private readonly IMessageService _messageService;
        private readonly IUserService _userService;

        public AdminLayoutNavbarMessageInboxViewComponent(IIdentityService identityService, IMessageService messageService, IUserService userService)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            messages.Where(x => x.IsRead == false).ToList().ForEach((message) =>
            {
